...
class JQueryDownloadProgressBarsTest extends ProgressBarAndSliderBase {

    private static final Logger LOG = LogManager.getLogger(JQueryDownloadProgressBarsTest.class);
