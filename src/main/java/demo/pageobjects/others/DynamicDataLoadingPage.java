package demo.pageobjects.others;
...
public class DynamicDataLoadingPage extends GenericBasePage {
    ...
    public DynamicDataLoadingPage actionOnFirstCheckBox(CheckBoxAction action) {
        checkCheckBox(firstCheckBox, action);
        return this;
    }

    public DynamicDataLoadingPage actionOnACheckBox(String checkBoxname, CheckBoxAction action) {
    ...
    public DynamicDataLoadingPage clikCheckAllButton() {
