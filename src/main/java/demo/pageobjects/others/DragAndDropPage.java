...
public class DragAndDropPage extends GenericBasePage {
    ...
    public DragAndDropPage actionOnFirstCheckBox(CheckBoxAction action) {
        checkCheckBox(firstCheckBox, action);
        return this;
    }

    public DragAndDropPage actionOnACheckBox(String checkBoxname, CheckBoxAction action) {
    ...
    public DragAndDropPage clikCheckAllButton() {
