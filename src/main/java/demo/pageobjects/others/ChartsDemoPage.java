...
public class ChartsDemoPage extends GenericBasePage {
    ...
    public ChartsDemoPage actionOnFirstCheckBox(CheckBoxAction action) {
        checkCheckBox(firstCheckBox, action);
        return this;
    }

    public ChartsDemoPage actionOnACheckBox(String checkBoxname, CheckBoxAction action) {
    ...
    public ChartsDemoPage clikCheckAllButton() {
