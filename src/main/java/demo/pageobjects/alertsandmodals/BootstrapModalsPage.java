...
public class BootstrapModalsPage extends AlertsAndModalsBasePage {
    ...
    public BootstrapModalsPage actionOnFirstCheckBox(CheckBoxAction action) {
        checkCheckBox(firstCheckBox, action);
        return this;
    }

    public BootstrapModalsPage actionOnACheckBox(String checkBoxname, CheckBoxAction action) {
    ...
    public BootstrapModalsPage clikCheckAllButton() {
