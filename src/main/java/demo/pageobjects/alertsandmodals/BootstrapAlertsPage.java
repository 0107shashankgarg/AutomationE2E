...
public class BootstrapAlertsPage extends AlertsAndModalsBasePage {
    ...
    public BootstrapAlertsPage actionOnFirstCheckBox(CheckBoxAction action) {
        checkCheckBox(firstCheckBox, action);
        return this;
    }

    public BootstrapAlertsPage actionOnACheckBox(String checkBoxname, CheckBoxAction action) {
    ...
    public BootstrapAlertsPage clikCheckAllButton() {
