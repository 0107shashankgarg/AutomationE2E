...
public class ProgressBarModalsPage extends AlertsAndModalsBasePage {
    ...
    public ProgressBarModalsPage actionOnFirstCheckBox(CheckBoxAction action) {
        checkCheckBox(firstCheckBox, action);
        return this;
    }

    public ProgressBarModalsPage actionOnACheckBox(String checkBoxname, CheckBoxAction action) {
    ...
    public ProgressBarModalsPage clikCheckAllButton() {
