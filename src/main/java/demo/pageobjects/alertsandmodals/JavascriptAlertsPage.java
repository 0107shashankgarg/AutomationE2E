...
public class JavascriptAlertsPage extends AlertsAndModalsBasePage {
    ...
    public JavascriptAlertsPage actionOnFirstCheckBox(CheckBoxAction action) {
        checkCheckBox(firstCheckBox, action);
        return this;
    }

    public JavascriptAlertsPage actionOnACheckBox(String checkBoxname, CheckBoxAction action) {
    ...
    public JavascriptAlertsPage clikCheckAllButton() {
