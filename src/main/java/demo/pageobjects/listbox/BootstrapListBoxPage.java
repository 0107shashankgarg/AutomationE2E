...
public class BootstrapListBoxPage extends DatePickerBasePage {
    ...
    public BootstrapListBoxPage actionOnFirstCheckBox(CheckBoxAction action) {
        checkCheckBox(firstCheckBox, action);
        return this;
    }

    public BootstrapListBoxPage actionOnACheckBox(String checkBoxname, CheckBoxAction action) {
    ...
    public BootstrapListBoxPage clikCheckAllButton() {
