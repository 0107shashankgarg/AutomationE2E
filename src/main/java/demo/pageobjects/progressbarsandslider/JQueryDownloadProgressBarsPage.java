...
public class JQueryDownloadProgressBarsPage extends ProgressBarsAndSliderBasePage {
    ...
    public JQueryDownloadProgressBarsPage actionOnFirstCheckBox(CheckBoxAction action) {
        checkCheckBox(firstCheckBox, action);
        return this;
    }

    public JQueryDownloadProgressBarsPage actionOnACheckBox(String checkBoxname, CheckBoxAction action) {
    ...
    public JQueryDownloadProgressBarsPage clikCheckAllButton() {
