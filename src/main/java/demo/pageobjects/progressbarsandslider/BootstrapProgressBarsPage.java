...
public class BootstrapProgressBarsPage extends ProgressBarsAndSliderBasePage {
    ...
    public BootstrapProgressBarsPage actionOnFirstCheckBox(CheckBoxAction action) {
        checkCheckBox(firstCheckBox, action);
        return this;
    }

    public BootstrapProgressBarsPage actionOnACheckBox(String checkBoxname, CheckBoxAction action) {
    ...
    public BootstrapProgressBarsPage clikCheckAllButton() {
