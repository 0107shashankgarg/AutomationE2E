...
public class InputFormSubmitPage extends InputFormsBasePage {
    ...
    public InputFormSubmitPage actionOnFirstCheckBox(CheckBoxAction action) {
        checkCheckBox(firstCheckBox, action);
        return this;
    }

    public InputFormSubmitPage actionOnACheckBox(String checkBoxname, CheckBoxAction action) {
    ...
    public InputFormSubmitPage clikCheckAllButton() {
