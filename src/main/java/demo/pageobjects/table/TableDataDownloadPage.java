...
public class TableDataDownloadPage extends TableBasePage {
    ...
    public TableDataDownloadPage actionOnFirstCheckBox(CheckBoxAction action) {
        checkCheckBox(firstCheckBox, action);
        return this;
    }

    public TableDataDownloadPage actionOnACheckBox(String checkBoxname, CheckBoxAction action) {
    ...
    public TableDataDownloadPage clikCheckAllButton() {
