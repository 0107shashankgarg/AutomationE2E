...
public class TableSortAndSearchPage extends TableBasePage {
    ...
    public TableSortAndSearchPage actionOnFirstCheckBox(CheckBoxAction action) {
        checkCheckBox(firstCheckBox, action);
        return this;
    }

    public TableSortAndSearchPage actionOnACheckBox(String checkBoxname, CheckBoxAction action) {
    ...
    public TableSortAndSearchPage clikCheckAllButton() {
