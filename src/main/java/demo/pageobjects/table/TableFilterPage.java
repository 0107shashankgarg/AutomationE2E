...
public class TableFilterPage extends TableBasePage {
    ...
    public TableFilterPage actionOnFirstCheckBox(CheckBoxAction action) {
        checkCheckBox(firstCheckBox, action);
        return this;
    }

    public TableFilterPage actionOnACheckBox(String checkBoxname, CheckBoxAction action) {
    ...
    public TableFilterPage clikCheckAllButton() {
