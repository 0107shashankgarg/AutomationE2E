...
public class DBTablePrinter {
    ...
    private static final int CATEGORY_INTEGER = 2;
    private static final int CATEGORY_DOUBLE = 3;
    private static final int CATEGORY_DATETIME = 4;
    private static final int CATEGORY_BOOLEAN = 5;
